...
9/21(월) 2시까지 주문건은 당일 출고되며, 이후 결제 건은 9/28(월)부터 순차적으로 출고됩니다.

다만, 연휴 전후 물량 증가로 인해 기존 배송 소요일보다 영업일 기준 2~3일 추가 소요될 수 있는 점 양해 부탁드립니다. 🙇‍♀️`, `9/21(월) 2시 이후 결제 건부터~ ※ 단, 문의 시점에 이미 정상 출고 및 배송 흐름 확인되는 경우 각 송장 흐름에 따라 기존 배송 템플릿으로 안내`)}
