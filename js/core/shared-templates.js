...
※ 제주·도서산간은 권역에 따라 집하 조기 마감 및 배송 중지·지연 가능`)}
  ...
  ${macro("", "배송일정문의_추석연휴", `💡 고객님 주문 건은 <b>9/22(화) 오후 2시 이후 결제 건</b>으로 확인됩니다.

추석 연휴로 인한 물류센터 및 택배사 운영 일정에 따라
<b>9/22(화) 오후 2시 결제 건부터 9/27(일)까지 출고 업무가 진행되지 않습니다.</b>

해당 주문 건은 <b>9/28(월)부터 순차 출고</b>로,
출고 후 배송 완료까지는 영업일 기준 2~3일 정도 소요되며, 연휴 전후 물량 증가로 인해 기존 배송 소요일보다 1~2일 정도 추가 소요될 수 있는 점 양해 부탁드립니다.🙇‍♀️
