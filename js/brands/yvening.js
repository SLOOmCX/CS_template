...
반품 전 꼭 확인 부탁드립니다.`)
  ...
  <div class="grid2">
    ${subcard(D_YVENING["yvening_refund__010"].name, D_YVENING["yvening_refund__010"].tag, D_YVENING["yvening_refund__010"].body, D_YVENING["yvening_refund__010"].desc)}
...
subcard(D_YVENING["yvening_exchange__007"].name, D_YVENING["yvening_exchange__007"].tag, D_YVENING["yvening_exchange__007"].body, D_YVENING["yvening_exchange__007"].desc) + caution(`🎁 증정품 회수 X`)
  ...
  ${subcard(D_YVENING["yvening_exchange__008"].name, D_YVENING["yvening_exchange__008"].tag, D_YVENING["yvening_exchange__008"].body, D_YVENING["yvening_exchange__008"].desc)}
