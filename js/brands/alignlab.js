...
💡 고객이 변경된 기간별 정책에 대해 이의나 불만을 제기하는 경우 무상 AS·유상 AS의 관련 템플릿을 참고하여 응대</div>
  ...
  <div class="grid2">${subcard(D_ALIGNLAB["align_as__001"].name, D_ALIGNLAB["align_as__001"].tag, D_ALIGNLAB["align_as__001"].body, D_ALIGNLAB["align_as__001"].desc, "align_as__001", "alignlab")}${subcard(D_ALIGNLAB["align_as__002"].name, D_ALIGNLAB["align_as__002"].tag, D_ALIGNLAB["align_as__002"].body, D_ALIGNLAB["align_as__002"].desc, "align_as__002", "alignlab")}</div>
  ...
  <div class="lvl2-body">${guide(`📌 해당 증상 CS건은 <b>사용법 오인으로 인한 불량 문의가 많으므로 제품별 유의사항 또는 사용법 안내가 선행</b>되어야 함\n⚠️ 단, <span style="color:#1B3A68">ALF·워크플로우에서 관련 안내가 완료된 경우에는아래 제품별 유의사항 중복 안내를 생략</span>하고, Flow 및 고객 증빙을 확인하여 미확인 사항만 추가 확인 `)}<div class="typ" id="t1"><span class="tnum">1</span>충전/전원/작동</div><div class="lvl3-body"><div class="quote-box"><b>📌 얼라인랩 디바이스 제품 안내</b>\n· 충전·전원·작동 불량 문의 시 5V 1A 정격전압 사용 여부 확인은 필수입니다.\n· 정격전압이 확인되지 않은 경우에는 반드시 증빙 확인 후 불량 여부 판단</div><div class="quote-box"><b>제품별 유의사항은 <a href="https://docs.google.com/spreadsheets/d/1OwcLG2XuwPUHt7grmSIjpWsZqU8MAhWPrcp-RVykLMI/edit?gid=826394219#gid=826394219" target="_blank">[얼라인랩] 제품별 사용법 템플릿</a> 시트 또는 채널톡 매크로 이용</b></div><div class="grid2">${macro(D_ALIGNLAB["align_as__003"].name, D_ALIGNLAB["align_as__003"].tag, D_ALIGNLAB["align_as__003"].body, D_ALIGNLAB["align_as__003"].desc, "align_as__003", "alignlab")}${macro(D_ALIGNLAB["align_as__004"].name, D_ALIGNLAB["align_as__004"].tag, D_ALIGNLAB["align_as__004"].body, D_ALIGNLAB["align_as__004"].desc, "align_as__004", "alignlab")}</div><div class="h3lvl">🔴 제품별 정격전압 사용여부 확인</div>
  <div class="lvl3-body"><div class="grid2"><div class="flowgroup">${subcard(D_ALIGNLAB["align_as__005"].name, D_ALIGNLAB["align_as__005"].tag, D_ALIGNLAB["align_as__005"].body, D_ALIGNLAB["align_as__005"].desc, "align_as__005", "alignlab")}</div><div class="flowgroup">${subcard(D_ALIGNLAB["align_as__006"].name, D_ALIGNLAB["align_as__006"].tag, D_ALIGNLAB["align_as__006"].body, D_ALIGNLAB["align_as__006"].desc, "align_as__006", "alignlab")}</div></div>${guide(`✔️ 고객 정상 사용 답변 시 상담 종료 유도 (무응답 종료 포함)\n✔️ 올바르게 사용 주장 + 증빙(사진·영상) 미흡 시 <a class="jump-link" href="#evidCheck" onclick="return jumpTo('evidCheck')">② 증빙 확인 (사진/영상)</a> 단계로 이동\n✔️ 올바르게 사용 주장 + 증빙(사진·영상) 확인 완료 시 <a class="jump-link" href="#step2" onclick="return jumpTo('step2')">3. AS 접수</a> 로 이동`)}</div>
  <div class="h3lvl" id="evidCheck">② 증빙 확인 (사진/영상)</div><div class="lvl3-body">${caution(`⚠️  단, 추가 증빙 자료 요청은 고객이 선첨부한 자료(사진/영상)가 있을 시엔 미흡할 경우에만  진행`)}<div class="grid2">${subcard(D_ALIGNLAB["align_as__007"].name, D_ALIGNLAB["align_as__007"].tag, D_ALIGNLAB["align_as__007"].body, D_ALIGNLAB["align_as__007"].desc, "align_as__007", "alignlab")}${subcard(D_ALIGNLAB["align_as__008"].name, D_ALIGNLAB["align_as__008"].tag, D_ALIGNLAB["align_as__008"].body, D_ALIGNLAB["align_as__008"].desc, "align_as__008", "alignlab")}</div><div class="grid2">${subcard(D_ALIGNLAB["align_as__009"].name, D_ALIGNLAB["align_as__009"].tag, D_ALIGNLAB["align_as__009"].body, D_ALIGNLAB["align_as__009"].desc, "align_as__009", "alignlab")}</div>${guide(`<b>👉🏻 증빙(사진·영상) 확인 완료 시 <a class="jump-link" href="#step2" onclick="return jumpTo('step2')">3. AS 접수</a>로 이동</b>`)}</div><div class="grp-h">🔷 작동 관련 증상</div>${caution(`⚠️ 제품별 작동 관련 증상은 상이 (버튼으로 바람 세기 조절이 안됨, 강도 조절이 안됨 등) 하며 충전/전원 불량이 아닌 사진/영상으로 확인 가능한 모든 작동 불량을 포함함.`)}${macro(D_ALIGNLAB["align_as__010"].name, D_ALIGNLAB["align_as__010"].tag, D_ALIGNLAB["align_as__010"].body, D_ALIGNLAB["align_as__010"].desc, "align_as__010", "alignlab")}${guide(`<b>👉🏻 증빙(사진·영상) 확인 완료 시 <a class="jump-link" href="#step2" onclick="return jumpTo('step2')">3. AS 접수</a>로 이동</b>`)}</div><div class="typ" id="t3"><span class="tnum">2</span>진동/EMS 강도</div><div class="lvl3-body"><div class="quote-box"><b>⚠️ 유의사항</b>\n✔️ 본 유형은 진동·EMS 체감 강도 관련 문의에만 적용\n→ 고객 체감에 따른 문의로 사진·영상만으로는 확인이 어려운 유형이므로, 증빙(사진·영상)은 요청하지 않습니다.\n✔️ '리프핏 아이' 제품은 진동 불량(눈가 진동이 느껴지지 않음) 문의 시 응대 기준이 다릅니다.\n→ 아래 제품에 맞는 템플릿을 선택하여 안내\n🔷 리프핏 아이&nbsp;&nbsp;&nbsp;🔷 그 외 제품</div><table style="border-collapse:collapse;width:100%;margin:6px 0 14px;font-size:13px"><thead><tr><th style="background:#9BBB59;color:#fff;padding:9px 12px;text-align:left;border:1px solid #d9d9d9">👉 적용 예시</th><th style="background:#9BBB59;color:#fff;padding:9px 12px;text-align:left;border:1px solid #d9d9d9">👉 미적용 예시 (작동 불량 등으로 진행)</th></tr></thead><tbody><tr><td style="padding:9px 12px;border:1px solid #d9d9d9;vertical-align:top">눈가 진동이 안느껴져요. EMS 자극이 없어요 등</td><td style="padding:9px 12px;border:1px solid #d9d9d9;vertical-align:top">온도·강도 조절 버튼 불량 / EMS 단계 조절 기능 자체 불량 등</td></tr></tbody></table><div class="grp-h">🔷 리프핏 아이</div><div class="quote-box"><b>⚠️ 리프핏 아이(눈가 진동 미체감)는 일반 불량 프로세스와 상이</b>\n· 최초 문의 : 사용법 안내 후 최소 2주 사용 권장\n· 이후 동일 증상 또는 고객 미수긍 시 품질보증기간 기준 교환 접수\n· 회수&검수 안내는 동일하지만, 실제 운영은 회수 완료 후 재출고 교환으로 진행 (검수 결과에 따른 정상/불량 판정 없음)</div><div class="grp-h">① 올바른 사용법 안내</div>${macro(D_ALIGNLAB["align_as__011"].name, D_ALIGNLAB["align_as__011"].tag, D_ALIGNLAB["align_as__011"].body, D_ALIGNLAB["align_as__011"].desc, "align_as__011", "alignlab")}<div class="grp-h">② 고객 수긍 여부에 따른 안내</div><div class="grid2"><div>${macro(D_ALIGNLAB["align_as__012"].name, D_ALIGNLAB["align_as__012"].tag, D_ALIGNLAB["align_as__012"].body, D_ALIGNLAB["align_as__012"].desc, "align_as__012", "alignlab")}</div><div>${macro(D_ALIGNLAB["align_as__013"].name, D_ALIGNLAB["align_as__013"].tag, D_ALIGNLAB["align_as__013"].body, D_ALIGNLAB["align_as__013"].desc, "align_as__013", "alignlab")}${macro(D_ALIGNLAB["align_as__014"].name, D_ALIGNLAB["align_as__014"].tag, D_ALIGNLAB["align_as__014"].body, D_ALIGNLAB["align_as__014"].desc, "align_as__014", "alignlab")}</div></div>${guide(`💡 기존 무상 교환과 다르게, 리프핏 아이의 무상 교환의 경우 \n회수&재출고 동시 진행이 아닌, 기존 제품 수거 완료 이후 재출고 처리!`)}${guide(`👉🏻 이후 <a class="jump-link" href="#freeFlow" onclick="return jumpTo('freeFlow')">🛠️ 무상 AS</a>로 이동하여 flow 대로 진행`)}<div class="grp-h">🔷 그 외 제품</div><div class="quote-box"><b>📌  리프핏 아이 외 제품의 진동·EMS 강도 불량 문의</b>\n→ 제품별 올바른 사용법(정격전압·크림 사용 등) 안내 후 재사용 권장\n→ 올바른 방법으로 사용 후에도 동일 증상을 지속 주장하는 경우 제품 회수·검수 후 결과에 따라 처리합니다. (채팅 상담으로 증상 확인 불가)\n\n⚠️ 단, ALF·워크플로우에서 관련 안내가 완료된 경우에는아래 제품별 유의사항 중복 안내를 생략하고, Flow 및 고객 증빙을 확인하여 미확인 사항만 추가 확인</div><div class="grp-h">① 올바른 사용법 안내</div><div class="quote-box"><b>제품별 유의사항은 <a href="https://docs.google.com/spreadsheets/d/1OwcLG2XuwPUHt7grmSIjpWsZqU8MAhWPrcp-RVykLMI/edit?gid=826394219#gid=826394219" target="_blank">[얼라인랩] 제품별 사용법 템플릿</a> 시트 또는 채널톡 매크로 이용</b></div><div class="grid2"><div>${macro(D_ALIGNLAB["align_as__015"].name, D_ALIGNLAB["align_as__015"].tag, D_ALIGNLAB["align_as__015"].body, D_ALIGNLAB["align_as__015"].desc, "align_as__015", "alignlab")}</div><div>${macro(D_ALIGNLAB["align_as__016"].name, D_ALIGNLAB["align_as__016"].tag, D_ALIGNLAB["align_as__016"].body, D_ALIGNLAB["align_as__016"].desc, "align_as__016", "alignlab")}${macro(D_ALIGNLAB["align_as__017"].name, D_ALIGNLAB["align_as__017"].tag, D_ALIGNLAB["align_as__017"].body, D_ALIGNLAB["align_as__017"].desc, "align_as__017", "alignlab")}</div></div>${guide(`✨ 리프핏 숄더는 전용 크림(리프핏 바디 크림)을 사용하는 제품으로 EMS 강도 문의는 아래 별도 사용법 템플릿 사용`)}${macro(D_ALIGNLAB["align_as__018"].name, D_ALIGNLAB["align_as__018"].tag, D_ALIGNLAB["align_as__018"].body, D_ALIGNLAB["align_as__018"].desc, "align_as__018", "alignlab")}<div class="grp-h">② 회수·검수 안내</div>${macro(D_ALIGNLAB["align_as__019"].name, D_ALIGNLAB["align_as__019"].tag, D_ALIGNLAB["align_as__019"].body, D_ALIGNLAB["align_as__019"].desc, "align_as__019", "alignlab")}${guide(`👉🏻 이후 <a class="jump-link" href="#freeFlow" onclick="return jumpTo('freeFlow')">🛠️ 무상 AS</a>로 이동하여 flow 대로 진행`)}</div></div>
  <div class="h2lvl as-sub" id="groupB">B. 사용법 안내 불필요</div>
  <div class="lvl2-body"><div class="typ" id="tsound"><span class="tnum">3</span>소음 강도 &amp; 쿠팡/네이버 자동수거</div><div class="lvl3-body"><div class="grid2"><div class="quote-box"><b>✔️ 소음 강도 불량</b>\n① 사용자의 '체감 강도(소음)' 관련 문의만 해당함\n→ 육안으로 확인이 어려운 유형으로, 사진/영상 요청은 진행하지 않음\n② 사진/영상으로 확인 불가하므로 회수·검수 후 결과에 따라 진행</div><div class="quote-box"><b>✔️ 쿠팡/네이버 스마트스토어 자동수거 건</b>\n① 쿠팡·네이버 스마트스토어 고객 직접 신청 건 중 자동 수거 진행 중인 건\n→ 각 어드민에서 자동 수거 진행 여부를 확인\n② 자동 수거 진행 중엔 철회가 어려우므로, 회수·검수 후 결과에 따라 처리 가능함을 안내</div></div><table style="border-collapse:collapse;width:100%;margin:6px 0 14px;font-size:13px"><thead><tr><th style="background:#9BBB59;color:#fff;padding:9px 12px;text-align:left;border:1px solid #d9d9d9">👉 소리 강도 불량 적용 예시</th><th style="background:#9BBB59;color:#fff;padding:9px 12px;text-align:left;border:1px solid #d9d9d9">👉 소리 강도 불량 미적용 예시 (작동 불량 등으로 진행)</th></tr></thead><tbody><tr><td style="padding:9px 12px;border:1px solid #d9d9d9;vertical-align:top">소리가 너무 커요 등</td><td style="padding:9px 12px;border:1px solid #d9d9d9;vertical-align:top">작동 시 발생하는 비정상 잡음 등</td></tr></tbody></table><div class="grp-h">① 회수 및 검수 과정 안내</div>${macro(D_ALIGNLAB["align_as__020"].name, D_ALIGNLAB["align_as__020"].tag, D_ALIGNLAB["align_as__020"].body, D_ALIGNLAB["align_as__020"].desc, "align_as__020", "alignlab")}${guide(`💡 자동수거 물류센터 회수 내역 조회는 입고 완료 후에만 조회됨\n회수중 상태에서는 물류센터(품고 또는 정석)에서 조회되지 않음`)}<div class="grid2"><div>${macro(D_ALIGNLAB["align_as__021"].name, D_ALIGNLAB["align_as__021"].tag, D_ALIGNLAB["align_as__021"].body, D_ALIGNLAB["align_as__021"].desc, "align_as__021", "alignlab")}${guide(`물류센터(품고 또는 정석) 별도반출&불량 검수 시트에 취합 후 검수 결과에 따라\n✔️ '정상'일 경우 → 고객 주소로 반송\n✔️ '불량'일 경우 → 품질보증기간 정책에 따라 진행\n\n👇🏻 고객 회수·검수에 대해 불만 제기할 경우 ② 검수 소요기간 불만 시 참고하여 진행\n\n👉🏻 물류센터별 시트 바로가기\n① <a href="https://docs.google.com/spreadsheets/d/1ZgqMOaFfBW60cln1V6oVRRSmjEeNjZSJrlf1ytdM5V4/edit?pli=1&amp;gid=1560630591#gid=1560630591" target="_blank">[품고/올릿] 별도반출&불량 검수</a>\n② <a href="https://docs.google.com/spreadsheets/d/1X7-VBL7xA8UWJtdHh5elOtYrDaA-qwtrrvc0qrM5_eU/edit?gid=0#gid=0" target="_blank">[정석/올릿] 별도반출&불량 검수</a>`)}</div><div>${macro(D_ALIGNLAB["align_as__022"].name, D_ALIGNLAB["align_as__022"].tag, D_ALIGNLAB["align_as__022"].body, D_ALIGNLAB["align_as__022"].desc, "align_as__022", "alignlab")}${guide(`물류센터(품고 또는 정석) 별도반출&불량 검수 시트에 취합 후 검수 결과에 따라\n✔️ '정상'일 경우 → 고객 주소로 반송\n✔️ '불량'일 경우 → 고객 접수한 처리 방안대로 진행\n\n※ 쿠팡 건은 검수 결과 확인 전 쿠팡 자체적으로 기한 내 반품 완료 처리되는 경우가 대부분\n→ 고객 별도 안내 불필요, 시스템만 인지하고 이해하기!\n\n👉🏻 추후 검수 결과에 따라 <a class="jump-link" href="#exNoEvid" onclick="return jumpTo('exNoEvid')">✨ [예외] 증빙 미제출</a> flow 대로 진행\n\n👉🏻 물류센터별 시트 바로가기\n① <a href="https://docs.google.com/spreadsheets/d/1ZgqMOaFfBW60cln1V6oVRRSmjEeNjZSJrlf1ytdM5V4/edit?pli=1&amp;gid=1560630591#gid=1560630591" target="_blank">[품고/올릿] 별도반출&불량 검수</a>\n② <a href="https://docs.google.com/spreadsheets/d/1X7-VBL7xA8UWJtdHh5elOtYrDaA-qwtrrvc0qrM5_eU/edit?gid=0#gid=0" target="_blank">[정석/올릿] 별도반출&불량 검수</a>`)}</div></div><div class="grp-h">② 검수 소요기간 불만 시</div><div class="grid2"><div>${macro(D_ALIGNLAB["align_as__023"].name, D_ALIGNLAB["align_as__023"].tag, D_ALIGNLAB["align_as__023"].body, D_ALIGNLAB["align_as__023"].desc, "align_as__023", "alignlab")}</div><div>${macro(D_ALIGNLAB["align_as__024"].name, D_ALIGNLAB["align_as__024"].tag, D_ALIGNLAB["align_as__024"].body, D_ALIGNLAB["align_as__024"].desc, "align_as__024", "alignlab")}${macro(D_ALIGNLAB["align_as__025"].name, D_ALIGNLAB["align_as__025"].tag, D_ALIGNLAB["align_as__025"].body, D_ALIGNLAB["align_as__025"].desc, "align_as__025", "alignlab")}</div></div>${guide(`※ 사무실 반출 필요 건은 물류센터(품고 또는 정석) 별도반출&불량 검수 요청 시트 M열(구분) 별도반출로 선택 필수 > 매주 화요일에 퀵으로 일괄 반출됨\n\n👉🏻 물류센터별 시트 바로가기\n① <a href="https://docs.google.com/spreadsheets/d/1ZgqMOaFfBW60cln1V6oVRRSmjEeNjZSJrlf1ytdM5V4/edit?pli=1&amp;gid=1560630591#gid=1560630591" target="_blank">[품고/올릿] 별도반출&불량 검수</a>\n② <a href="https://docs.google.com/spreadsheets/d/1X7-VBL7xA8UWJtdHh5elOtYrDaA-qwtrrvc0qrM5_eU/edit?gid=0#gid=0" target="_blank">[정석/올릿] 별도반출&불량 검수</a>`)}${guide(`👉🏻 이후 검수 결과에 따라 <a class="jump-link" href="#exNoEvid" onclick="return jumpTo('exNoEvid')">✨ [예외] 증빙 미제출</a> flow 대로 진행`)}</div><div class="typ" id="t5"><span class="tnum">4</span>구성품 누락</div><div class="lvl3-body"><div class="quote-box"><b>⚠️ 상품 수령일로부터 영업일 7일 이내 문의 시에만 처리 가능</b></div><div class="grp-h">① 배송 완료일자 확인</div><div class="grid2">${macro(D_ALIGNLAB["align_as__026"].name, D_ALIGNLAB["align_as__026"].tag, D_ALIGNLAB["align_as__026"].body, D_ALIGNLAB["align_as__026"].desc, "align_as__026", "alignlab")}${macro(D_ALIGNLAB["align_as__027"].name, D_ALIGNLAB["align_as__027"].tag, D_ALIGNLAB["align_as__027"].body, D_ALIGNLAB["align_as__027"].desc, "align_as__027", "alignlab")}</div>${guide(`▶ 고객 강하게 미수긍 시 예외 처리 진행`)}${macro(D_ALIGNLAB["align_as__028"].name, D_ALIGNLAB["align_as__028"].tag, D_ALIGNLAB["align_as__028"].body, D_ALIGNLAB["align_as__028"].desc, "align_as__028", "alignlab")}<div class="grp-h">2️⃣ 별도 재출고 안내</div>${macro(D_ALIGNLAB["align_as__029"].name, D_ALIGNLAB["align_as__029"].tag, D_ALIGNLAB["align_as__029"].body, D_ALIGNLAB["align_as__029"].desc, "align_as__029", "alignlab")}${macro(D_ALIGNLAB["align_as__030"].name, D_ALIGNLAB["align_as__030"].tag, D_ALIGNLAB["align_as__030"].body, D_ALIGNLAB["align_as__030"].desc, "align_as__030", "alignlab")}${macro(D_ALIGNLAB["align_as__031"].name, D_ALIGNLAB["align_as__031"].tag, D_ALIGNLAB["align_as__031"].body, D_ALIGNLAB["align_as__031"].desc, "align_as__031", "alignlab")}<div class="grp-h">🔔 [예외케이스] 구성품 누락으로 전체 반품 희망</div><div class="quote-box"><b>상품 개봉 여부와 무관하게 제품 회수 및 전액 환불 처리로 진행</b></div>${macro(D_ALIGNLAB["align_as__032"].name, D_ALIGNLAB["align_as__032"].tag, D_ALIGNLAB["align_as__032"].body, D_ALIGNLAB["align_as__032"].desc, "align_as__032", "alignlab")}<div class="grp-h">② 결제수단별 환불 안내</div><div class="grid2">${col("blue","◆ 카드결제",subcard(D_ALIGNLAB["align_as__033"].name, D_ALIGNLAB["align_as__033"].tag, D_ALIGNLAB["align_as__033"].body, D_ALIGNLAB["align_as__033"].desc, "align_as__033", "alignlab"))}${col("pink","◆ 계좌 환불",`<div class="stack">`+subcard(D_ALIGNLAB["align_as__034"].name, D_ALIGNLAB["align_as__034"].tag, D_ALIGNLAB["align_as__034"].body, D_ALIGNLAB["align_as__034"].desc, "align_as__034", "alignlab")+subcard(D_ALIGNLAB["align_as__035"].name, D_ALIGNLAB["align_as__035"].tag, D_ALIGNLAB["align_as__035"].body, D_ALIGNLAB["align_as__035"].desc, "align_as__035", "alignlab")+`</div>`)}</div></div><div class="typ" id="t6"><span class="tnum">5</span>이염/오염/초도파손/스크래치</div><div class="lvl3-body"><div class="quote-box"><b>⚠️ 상품 수령일로부터 영업일 7일 이내 문의 시에만 처리 가능</b></div><div class="grp-h">① 배송 완료일자 확인</div><div class="grid2">${macro(D_ALIGNLAB["align_as__036"].name, D_ALIGNLAB["align_as__036"].tag, D_ALIGNLAB["align_as__036"].body, D_ALIGNLAB["align_as__036"].desc, "align_as__036", "alignlab")}${macro(D_ALIGNLAB["align_as__037"].name, D_ALIGNLAB["align_as__037"].tag, D_ALIGNLAB["align_as__037"].body, D_ALIGNLAB["align_as__037"].desc, "align_as__037", "alignlab")}</div>${guide(`▶ 고객 강하게 미수긍 시 예외 처리 진행`)}${macro(D_ALIGNLAB["align_as__038"].name, D_ALIGNLAB["align_as__038"].tag, D_ALIGNLAB["align_as__038"].body, D_ALIGNLAB["align_as__038"].desc, "align_as__038", "alignlab")}<div class="grp-h">② 고객 요청 처리 방안 확인</div>${macro(D_ALIGNLAB["align_as__039"].name, D_ALIGNLAB["align_as__039"].tag, D_ALIGNLAB["align_as__039"].body, D_ALIGNLAB["align_as__039"].desc, "align_as__039", "alignlab")}${guide(`⚠️ 상품수령일로부터 7일 이내 이염/오염/초도파손은 고객이 원하는 처리 방안(교환 또는 반품) 확인 후 진행 (단, 기간별 정책에 따라만 진행 가능)\n👉🏻 교환 요청 시 <a class="jump-link" href="#freeBranch" onclick="return jumpTo('freeBranch')">🔷 무상 교환 안내</a> 로 이동\n👉🏻 반품 요청 시 <a class="jump-link" href="#freePack" onclick="return jumpTo('freePack')">🔷 무상 반품 안내</a> 로 이동`)}</div></div>
  <div class="h2lvl" id="t4">🔁 재불량 (교환품 동일 증상)</div>
  <div class="lvl2-body">${caution(`👉 [예시] 2026.01.01 리프핏 아이 충전 불량으로 무상 교환 진행 → 2026.03.02 교환 제품에서 동일 증상(충전 불량)으로 재문의\n⚠️ 2번 연속으로 동일 증상 불량 주장 건(충전 불량으로 교환 받은 제품이 또 충전 불량 주장)의 경우 추가적인 교환 없이 반품 진행`)}<div class="grp-h">💡 공통 안내</div>${macro(D_ALIGNLAB["align_as__040"].name, D_ALIGNLAB["align_as__040"].tag, D_ALIGNLAB["align_as__040"].body, D_ALIGNLAB["align_as__040"].desc, "align_as__040", "alignlab")}${macro(D_ALIGNLAB["align_as__041"].name, D_ALIGNLAB["align_as__041"].tag, D_ALIGNLAB["align_as__041"].body, D_ALIGNLAB["align_as__041"].desc, "align_as__041", "alignlab")}<div class="grid2">${macro(D_ALIGNLAB["align_as__042"].name, D_ALIGNLAB["align_as__042"].tag, D_ALIGNLAB["align_as__042"].body, D_ALIGNLAB["align_as__042"].desc, "align_as__042", "alignlab")}${macro(D_ALIGNLAB["align_as__043"].name, D_ALIGNLAB["align_as__043"].tag, D_ALIGNLAB["align_as__043"].body, D_ALIGNLAB["align_as__043"].desc, "align_as__043", "alignlab")}</div>${macro(D_ALIGNLAB["align_as__044"].name, D_ALIGNLAB["align_as__044"].tag, D_ALIGNLAB["align_as__044"].body, D_ALIGNLAB["align_as__044"].desc, "align_as__044", "alignlab")}<div class="grp-h">③ 결제수단별 환불 안내</div><div class="grid2">${col("blue","◆ 카드결제",subcard(D_ALIGNLAB["align_as__045"].name, D_ALIGNLAB["align_as__045"].tag, D_ALIGNLAB["align_as__045"].body, D_ALIGNLAB["align_as__045"].desc, "align_as__045", "alignlab"))}${col("pink","◆ 계좌 환불",`<div class="stack">`+subcard(D_ALIGNLAB["align_as__046"].name, D_ALIGNLAB["align_as__046"].tag, D_ALIGNLAB["align_as__046"].body, D_ALIGNLAB["align_as__046"].desc, "align_as__046", "alignlab")+subcard(D_ALIGNLAB["align_as__047"].name, D_ALIGNLAB["align_as__047"].tag, D_ALIGNLAB["align_as__047"].body, D_ALIGNLAB["align_as__047"].desc, "align_as__047", "alignlab")+`</div>`)}</div></div>
...
· 상품 수령일 3개월 경과 → ⚠️ [예외] 3개월 경과 건이나 무상 반품 요청 (아래 템플릿 안내)</div><table class="astbl"><thead><tr><th style="width:210px">구분</th><th>안내</th></tr></thead><tbody><tr><td>수령일로부터 3개월 경과건<br>👉🏻 무상 반품 요청할 경우</td><td class="cmp-ment"><span class="tag">#ALAS_3개월경과_반품요청</span><button class="copy-btn" onclick="copyMacro(this)" title="복사">📋</button><div class="cmp-ment-body">고객님, 이용에 불편을 드려 죄송합니다. 🙏🏻\n확인 결과, 고객님의 제품은 수령일로부터 3개월이 경과한 것으로 확인되었습니다.\n\n얼라인랩은 공정거래위원회 소비자분쟁해결기준을 토대로, 품질보증기간 내 정상 사용 중 발생한 하자에 대해 기간별 AS 정책을 운영하고 있습니다.\n이에 따라 수령 후 3개월 이후에는 무상 반품이 아닌 무상 교환으로 진행되며, 고객님의 제품도 해당 기준에 따라 동일 제품으로 무상 교환을 도와드리는 점 양해 부탁드립니다.</div></td></tr><tr><td>수령일로부터 3개월 이내<br>👉🏻 무상 반품 요청할 경우</td><td><a class="jump-link" href="#freePack" onclick="return jumpTo('freePack')">🔷 무상 반품 안내</a> 로 이동하여 안내</td></tr></tbody></table>${macro(D_ALIGNLAB["align_as__048"].name, D_ALIGNLAB["align_as__048"].tag, D_ALIGNLAB["align_as__048"].body, D_ALIGNLAB["align_as__048"].desc, "align_as__048", "alignlab")}<div class="grp-h">a. 포장 및 회수 안내</div>${col("gray",`🔹 전체·부분 동일`,subcard(D_ALIGNLAB["align_as__049"].name, D_ALIGNLAB["align_as__049"].tag, D_ALIGNLAB["align_as__049"].body, D_ALIGNLAB["align_as__049"].desc, "align_as__049", "alignlab") + caution(`🎁 증정품 회수 X`))}${macro(D_ALIGNLAB["align_as__050"].name, D_ALIGNLAB["align_as__050"].tag, D_ALIGNLAB["align_as__050"].body, D_ALIGNLAB["align_as__050"].desc, "align_as__050", "alignlab")}${macro(D_ALIGNLAB["align_as__051"].name, D_ALIGNLAB["align_as__051"].tag, D_ALIGNLAB["align_as__051"].body, D_ALIGNLAB["align_as__051"].desc, "align_as__051", "alignlab")}<div class="grp-h">b. 검수 및 재출고 안내</div><div class="grid2"><div class="quote-box"><b>⚠️ 유의사항</b>\n① 접수 시간 기준으로 안내 필요\n② 불량으로 인한 재출고는 회수 접수와 동시에 재출고 접수\n⚠️ 단, 리프핏 아이 진동 강도 불량의 경우 회수·검수 완료 후 재출고 가능</div>${guide(`🔗 <a href="https://docs.google.com/spreadsheets/d/1t7Oa-rKPY2aYgphNugE5K5gMCP7Hn3joaJYp-bbh7Jw/edit?gid=1012913860#gid=1012913860" target="_blank">[자사/외부몰] 통합 교환/반품 관리</a> 시트에 리스트업 필수!\n👉🏻 회수·재출고 자동 등록`)}</div><div class="grid2">${subcard(D_ALIGNLAB["align_as__052"].name, D_ALIGNLAB["align_as__052"].tag, D_ALIGNLAB["align_as__052"].body, D_ALIGNLAB["align_as__052"].desc, "align_as__052", "alignlab")}${subcard(D_ALIGNLAB["align_as__053"].name, D_ALIGNLAB["align_as__053"].tag, D_ALIGNLAB["align_as__053"].body, D_ALIGNLAB["align_as__053"].desc, "align_as__053", "alignlab")}</div>${macro(D_ALIGNLAB["align_as__054"].name, D_ALIGNLAB["align_as__054"].tag, D_ALIGNLAB["align_as__054"].body, D_ALIGNLAB["align_as__054"].desc, "align_as__054", "alignlab")}</div><div class="h3lvl" id="freePack">🔷 무상 반품 안내</div><div class="lvl3-body"><div class="grp-h">a. 포장 및 회수 안내</div><div class="grid2">${col("blue",`🔹 전체 반품`,subcard(D_ALIGNLAB["align_as__055"].name, D_ALIGNLAB["align_as__055"].tag, D_ALIGNLAB["align_as__055"].body, D_ALIGNLAB["align_as__055"].desc, "align_as__055", "alignlab") + caution(`🎁 증정품 회수 O`))}${col("pink",`🔹 부분 반품`,subcard(D_ALIGNLAB["align_as__056"].name, D_ALIGNLAB["align_as__056"].tag, D_ALIGNLAB["align_as__056"].body, D_ALIGNLAB["align_as__056"].desc, "align_as__056", "alignlab") + caution(`🎁 증정품 회수 X`))}</div>${macro(D_ALIGNLAB["align_as__057"].name, D_ALIGNLAB["align_as__057"].tag, D_ALIGNLAB["align_as__057"].body, D_ALIGNLAB["align_as__057"].desc, "align_as__057", "alignlab")}<div class="stack">${col("gray",`💡 복합 유형 (불량 반품 + 단순변심 반품)`,subcard(D_ALIGNLAB["align_as__058"].name, D_ALIGNLAB["align_as__058"].tag, D_ALIGNLAB["align_as__058"].body, D_ALIGNLAB["align_as__058"].desc, "align_as__058", "alignlab") + caution(`🎁 증정품 회수 O`))}</div><div class="grid2">${macro(D_ALIGNLAB["align_as__059"].name, D_ALIGNLAB["align_as__059"].tag, D_ALIGNLAB["align_as__059"].body, D_ALIGNLAB["align_as__059"].desc, "align_as__059", "alignlab")}${macro(D_ALIGNLAB["align_as__060"].name, D_ALIGNLAB["align_as__060"].tag, D_ALIGNLAB["align_as__060"].body, D_ALIGNLAB["align_as__060"].desc, "align_as__060", "alignlab")}</div><div class="grp-h">b. 결제수단별 환불 안내</div><div class="grid2">${col("blue","◆ 카드결제",subcard(D_ALIGNLAB["align_as__061"].name, D_ALIGNLAB["align_as__061"].tag, D_ALIGNLAB["align_as__061"].body, D_ALIGNLAB["align_as__061"].desc, "align_as__061", "alignlab"))}${col("pink","◆ 계좌 환불",`<div class="stack">`+subcard(D_ALIGNLAB["align_as__062"].name, D_ALIGNLAB["align_as__062"].tag, D_ALIGNLAB["align_as__062"].body, D_ALIGNLAB["align_as__062"].desc, "align_as__062", "alignlab")+subcard(D_ALIGNLAB["align_as__063"].name, D_ALIGNLAB["align_as__063"].tag, D_ALIGNLAB["align_as__063"].body, D_ALIGNLAB["align_as__063"].desc, "align_as__063", "alignlab")+`</div>`)}</div></div></div><div class="h2lvl as-major" id="paidFlow">🔧 유상 AS</div>
  <div class="lvl2-body">
  <div class="h3lvl" id="paidCost">① 유상 비용 안내</div>
  <div class="lvl3-body">${macro(D_ALIGNLAB["align_as__064"].name, D_ALIGNLAB["align_as__064"].tag, D_ALIGNLAB["align_as__064"].body, D_ALIGNLAB["align_as__064"].desc, "align_as__064", "alignlab")}
  ${macro(D_ALIGNLAB["align_as__065"].name, D_ALIGNLAB["align_as__065"].tag, D_ALIGNLAB["align_as__065"].body, D_ALIGNLAB["align_as__065"].desc, "align_as__065", "alignlab")}
  ...
  ${macro(D_ALIGNLAB["align_as__066"].name, D_ALIGNLAB["align_as__066"].tag, D_ALIGNLAB["align_as__066"].body, D_ALIGNLAB["align_as__066"].desc, "align_as__066", "alignlab")}
  ...
  ${macro(D_ALIGNLAB["align_as__067"].name, D_ALIGNLAB["align_as__067"].tag, D_ALIGNLAB["align_as__067"].body, D_ALIGNLAB["align_as__067"].desc, "align_as__067", "alignlab")}
  ...
  ${macro(D_ALIGNLAB["align_as__068"].name, D_ALIGNLAB["align_as__068"].tag, D_ALIGNLAB["align_as__068"].body, D_ALIGNLAB["align_as__068"].desc, "align_as__068", "alignlab")}
  ...
  <div class="grid2">${subcard(D_ALIGNLAB["align_as__069"].name, D_ALIGNLAB["align_as__069"].tag, D_ALIGNLAB["align_as__069"].body, D_ALIGNLAB["align_as__069"].desc, "align_as__069", "alignlab")}${subcard(D_ALIGNLAB["align_as__070"].name, D_ALIGNLAB["align_as__070"].tag, D_ALIGNLAB["align_as__070"].body, D_ALIGNLAB["align_as__070"].desc, "align_as__070", "alignlab")}</div>
  ${macro(D_ALIGNLAB["align_as__071"].name, D_ALIGNLAB["align_as__071"].tag, D_ALIGNLAB["align_as__071"].body, D_ALIGNLAB["align_as__071"].desc, "align_as__071", "alignlab")}
  </div>
  <div class="h3lvl" id="paidDeposit">✔️ [유상비용 미입금 시] 상담 종료 유도</div>
  <div class="lvl3-body">${macro(D_ALIGNLAB["align_as__072"].name, D_ALIGNLAB["align_as__072"].tag, D_ALIGNLAB["align_as__072"].body, D_ALIGNLAB["align_as__072"].desc, "align_as__072", "alignlab")}</div>
  </div>
  <div class="h2lvl" id="edgeDiscon">🚨 [단종] EDGE CASE</div>
  <div class="lvl2-body"><div class="h3lvl" id="edgeIn">① 품질보증기간(1년) 이내 단종</div><div class="lvl3-body"><div class="quote-box"><b>📌 응대 가이드</b>\n동일 제품이 단종되어 교환이 불가능한 경우 적용\n① 유사 모델을 '유상교환 가격' 으로 구매 안내\n② 고객이 구매를 원하지 않는 경우 단종 보상 기준에 따라 <b>구입가를 자사몰 포인트로 대체 환급</b></div>${macro(D_ALIGNLAB["align_as__073"].name, D_ALIGNLAB["align_as__073"].tag, D_ALIGNLAB["align_as__073"].body, D_ALIGNLAB["align_as__073"].desc, "align_as__073", "alignlab")}${guide(`💡 1년 이내 유상 비용 금액으로 반영`)}<div class="grid2"><div class="flowgroup">${subcard(D_ALIGNLAB["align_as__074"].name, D_ALIGNLAB["align_as__074"].tag, D_ALIGNLAB["align_as__074"].body, D_ALIGNLAB["align_as__074"].desc, "align_as__074", "alignlab")}${subcard(D_ALIGNLAB["align_as__075"].name, D_ALIGNLAB["align_as__075"].tag, D_ALIGNLAB["align_as__075"].body, D_ALIGNLAB["align_as__075"].desc, "align_as__075", "alignlab")}</div>${subcard(D_ALIGNLAB["align_as__076"].name, D_ALIGNLAB["align_as__076"].tag, D_ALIGNLAB["align_as__076"].body, D_ALIGNLAB["align_as__076"].desc, "align_as__076", "alignlab")}</div>${guide(`👉🏻 i. 유사 제품 구매 동의_입금 안내 시 접수 시점에 따라 출고 안내`)}<div class="grid2">${subcard(D_ALIGNLAB["align_as__077"].name, D_ALIGNLAB["align_as__077"].tag, D_ALIGNLAB["align_as__077"].body, D_ALIGNLAB["align_as__077"].desc, "align_as__077", "alignlab")}${subcard(D_ALIGNLAB["align_as__078"].name, D_ALIGNLAB["align_as__078"].tag, D_ALIGNLAB["align_as__078"].body, D_ALIGNLAB["align_as__078"].desc, "align_as__078", "alignlab")}</div>${macro(D_ALIGNLAB["align_as__079"].name, D_ALIGNLAB["align_as__079"].tag, D_ALIGNLAB["align_as__079"].body, D_ALIGNLAB["align_as__079"].desc, "align_as__079", "alignlab")}</div><div class="h3lvl" id="edgeOut">② 품질보증기간(1년) 경과 단종</div><div class="lvl3-body"><div class="quote-box"><b>📌 응대 가이드</b>\n동일 제품이 단종되어 교환이 불가능한 경우 적용\n① 동일 부위·동일 용도의 유사 제품이 있는지 확인\n<span class="sub-ex">(예: 넥숄더프로 → 넥숄더힐링케어 V2)</span>\n② 유사 제품을 품질보증기간(1년) 경과 유상 교환 비용으로 구매할 수 있도록 안내\n③ 고객이 유사 제품 구매를 원하지 않는 경우, <b>감가상각을 반영한 잔여 금액에 구입가의 10%를 가산</b>하여 자사몰 포인트로 환급</div>${macro(D_ALIGNLAB["align_as__080"].name, D_ALIGNLAB["align_as__080"].tag, D_ALIGNLAB["align_as__080"].body, D_ALIGNLAB["align_as__080"].desc, "align_as__080", "alignlab")}${guide(`💡 1년 경과 유상 비용 금액으로 반영`)}<div class="grid2"><div class="flowgroup">${subcard(D_ALIGNLAB["align_as__081"].name, D_ALIGNLAB["align_as__081"].tag, D_ALIGNLAB["align_as__081"].body, D_ALIGNLAB["align_as__081"].desc, "align_as__081", "alignlab")}${subcard(D_ALIGNLAB["align_as__082"].name, D_ALIGNLAB["align_as__082"].tag, D_ALIGNLAB["align_as__082"].body, D_ALIGNLAB["align_as__082"].desc, "align_as__082", "alignlab")}</div><div class="flowgroup">${subcard(D_ALIGNLAB["align_as__083"].name, D_ALIGNLAB["align_as__083"].tag, D_ALIGNLAB["align_as__083"].body, D_ALIGNLAB["align_as__083"].desc, "align_as__083", "alignlab")}${subcard(D_ALIGNLAB["align_as__084"].name, D_ALIGNLAB["align_as__084"].tag, D_ALIGNLAB["align_as__084"].body, D_ALIGNLAB["align_as__084"].desc, "align_as__084", "alignlab")}</div></div></div></div>
  ...
  <div class="lvl2-body"><div class="quote-box"><b>✔️ 증빙(영상/사진)이 필요한 유형이나 지속 미수긍, 불만 제기 시 아래 flow로 진행</b></div><div class="grp-h">① 방어 멘트 1차</div>${guide(`👉 1번, 2번 중 선택하여 사용`)}<div class="grid2"><div>${macro(D_ALIGNLAB["align_as__085"].name, D_ALIGNLAB["align_as__085"].tag, D_ALIGNLAB["align_as__085"].body, D_ALIGNLAB["align_as__085"].desc, "align_as__085", "alignlab")}</div><div>${macro(D_ALIGNLAB["align_as__086"].name, D_ALIGNLAB["align_as__086"].tag, D_ALIGNLAB["align_as__086"].body, D_ALIGNLAB["align_as__086"].desc, "align_as__086", "alignlab")}</div></div><div class="grp-h">② 방어 멘트 2차</div>${guide(`👉 ① 방어 멘트 진행 시에도 미수긍할 경우`)}${macro(D_ALIGNLAB["align_as__087"].name, D_ALIGNLAB["align_as__087"].tag, D_ALIGNLAB["align_as__087"].body, D_ALIGNLAB["align_as__087"].desc, "align_as__087", "alignlab")}<div class="grp-h">③ 채팅 상담 유지 안내 (지금 촬영 불가 시)</div>${guide(`ex. 영상 미첨부로 촬영 후 재인입해야하거나, 채팅 전송 영상 미흡으로 재 촬영 필요 시 모두 포함`)}${macro(D_ALIGNLAB["align_as__088"].name, D_ALIGNLAB["align_as__088"].tag, D_ALIGNLAB["align_as__088"].body, D_ALIGNLAB["align_as__088"].desc, "align_as__088", "alignlab")}<div class="grid2">${guide(`⚠️ 단, 아래와 같은 경우에는 [채팅 상담 유지 안내] 후 채널톡 보류 처리로 진행\n(예시) 상담 중 촬영이 어려운 상황 / 외부에 있어 확인이 어려운 경우 등`)}<div class="quote-box"><b>📌 상담 보류 처리 기준</b>\n· 보류 기간 : 상담 진행 내일 오전까지\n→ 해당 기간 내 회신이 없을 경우, 장시간 무응답 매크로를 활용하여 상담 종료\n· 고객이 기존 보류 채팅창이 아닌 새로운 채팅창으로 재문의할 수 있음\n→ 해당 경우, 중복 상담 매크로를 활용하여 보류 및 상담 종료\n※ 매크로 사용 시 상황에 맞게 멘트 수정 필수</div></div><div class="grp-h">④ 회수 후 검수로 진행 안내 (①, ②, ③ 미수긍 시)</div><div class="grid2"><div class="quote-box"><b>👉 ①, ②, ③ 미수긍 시에만 제품 회수 후 물류센터 검수 절차로 진행</b>\n\n· 고객 희망하는 처리 방안(반품 or 교환)은 채널톡 워크플로우 및 우측 메모리값에서 확인 가능</div><div class="quote-box"><b>· 물류센터(품고 또는 정석) 별도반출&불량 검수 시트에 취합 후 검수 결과에 따라</b>\n✔️ '정상'일 경우 → 고객 주소로 반송\n✔️ '불량'일 경우 → 고객 원하는 방향으로 '교환' 또는 '반품' 처리\n\n👉🏻 물류센터별 시트 바로가기\n① <a href="https://docs.google.com/spreadsheets/d/1ZgqMOaFfBW60cln1V6oVRRSmjEeNjZSJrlf1ytdM5V4/edit?pli=1&amp;gid=1560630591#gid=1560630591" target="_blank">[품고/올릿] 별도반출&불량 검수</a>\n② <a href="https://docs.google.com/spreadsheets/d/1X7-VBL7xA8UWJtdHh5elOtYrDaA-qwtrrvc0qrM5_eU/edit?gid=0#gid=0" target="_blank">[정석/올릿] 별도반출&불량 검수</a></div></div>${macro(D_ALIGNLAB["align_as__089"].name, D_ALIGNLAB["align_as__089"].tag, D_ALIGNLAB["align_as__089"].body, D_ALIGNLAB["align_as__089"].desc, "align_as__089", "alignlab")}<div class="grp-h">🔴 수거 미수긍/불만 제기 시 — 1번 또는 2번 중 선택</div><div class="grid2"><div>${macro(D_ALIGNLAB["align_as__090"].name, D_ALIGNLAB["align_as__090"].tag, D_ALIGNLAB["align_as__090"].body, D_ALIGNLAB["align_as__090"].desc, "align_as__090", "alignlab")}</div><div>${macro(D_ALIGNLAB["align_as__091"].name, D_ALIGNLAB["align_as__091"].tag, D_ALIGNLAB["align_as__091"].body, D_ALIGNLAB["align_as__091"].desc, "align_as__091", "alignlab")}</div></div><div class="grp-h">💸 고객 반품 요청 & 결제수단 무통장/가상계좌일 경우에만, 환불 계좌 선탐색</div>${macro(D_ALIGNLAB["align_as__092"].name, D_ALIGNLAB["align_as__092"].tag, D_ALIGNLAB["align_as__092"].body, D_ALIGNLAB["align_as__092"].desc, "align_as__092", "alignlab")}${guide(`👉🏻 이후, <a class="jump-link" href="#exNoEvid" onclick="return jumpTo('exNoEvid')">✨ [예외] 증빙 미제출</a>로 이동하여 이어 진행`)}</div>
  <div class="h2lvl" id="exNoEvid">✨ [예외] 증빙 미제출</div>
  <div class="lvl2-body"><div class="quote-box"><b>✔️ 사진/영상 확인 시, 정상 제품으로 확인되거나 사용법 문제로 확인될 경우 → 증상별 올바른 사용법 재안내 후 재사용 시도 유도</b>\n⚠️ 아래 flow는 사진/영상 촬영 지속 미수긍으로 회수 후 검수 예외 처리 진행에 동의한 경우에만 이어서 안내</div><div class="h3lvl">❌ 검수 결과 — 불량 확인</div><div class="lvl3-body">${guide(`※ 채널톡 이전 상담 내역에 교환/반품 처리 방안 확인`)}<div class="grp-h">A. 고객 반품 요청 · 반품 안내 유저챗 발송</div><div class="grid2">${macro(D_ALIGNLAB["align_as__093"].name, D_ALIGNLAB["align_as__093"].tag, D_ALIGNLAB["align_as__093"].body, D_ALIGNLAB["align_as__093"].desc, "align_as__093", "alignlab")}${macro(D_ALIGNLAB["align_as__094"].name, D_ALIGNLAB["align_as__094"].tag, D_ALIGNLAB["align_as__094"].body, D_ALIGNLAB["align_as__094"].desc, "align_as__094", "alignlab")}</div><div class="grp-h">B. 고객 교환 요청 · 재출고 안내 유저챗 발송</div>${macro(D_ALIGNLAB["align_as__095"].name, D_ALIGNLAB["align_as__095"].tag, D_ALIGNLAB["align_as__095"].body, D_ALIGNLAB["align_as__095"].desc, "align_as__095", "alignlab")}</div><div class="h3lvl">⭕ 검수 결과 — 정상 제품</div><div class="lvl3-body">${macro(D_ALIGNLAB["align_as__096"].name, D_ALIGNLAB["align_as__096"].tag, D_ALIGNLAB["align_as__096"].body, D_ALIGNLAB["align_as__096"].desc, "align_as__096", "alignlab")}</div></div>
...
const ALIGNLAB_SIDE = `
  ...
  ${macro(D_ALIGNLAB["alignlab_side__001"].name, D_ALIGNLAB["alignlab_side__001"].tag, D_ALIGNLAB["alignlab_side__001"].body, D_ALIGNLAB["alignlab_side__001"].desc, "alignlab_side__001", "alignlab")}
  ...
  ${macro(D_ALIGNLAB["alignlab_side__002"].name, D_ALIGNLAB["alignlab_side__002"].tag, D_ALIGNLAB["alignlab_side__002"].body, D_ALIGNLAB["alignlab_side__002"].desc, "alignlab_side__002", "alignlab")}
  <div class="grp-h grp-major">🔹 a. 고객 서류 미수긍 시</div>
  ${guide(`👉🏻 고객 증빙 서류 미수긍 시 예외적으로 전액 환불 처리 안내`)}
  ${macro(D_ALIGNLAB["alignlab_side__003"].name, D_ALIGNLAB["alignlab_side__003"].tag, D_ALIGNLAB["alignlab_side__003"].body, D_ALIGNLAB["alignlab_side__003"].desc, "alignlab_side__003", "alignlab")}
  <div class="grp-h grp-major">🔹 b. 고객 서류 수긍 시</div>
  ${macro(D_ALIGNLAB["alignlab_side__004"].name, D_ALIGNLAB["alignlab_side__004"].tag, D_ALIGNLAB["alignlab_side__004"].body, D_ALIGNLAB["alignlab_side__004"].desc, "alignlab_side__004", "alignlab")}
  ${macro(D_ALIGNLAB["alignlab_side__005"].name, D_ALIGNLAB["alignlab_side__005"].tag, D_ALIGNLAB["alignlab_side__005"].body, D_ALIGNLAB["alignlab_side__005"].desc, "alignlab_side__005", "alignlab")}
  ...
  ${macro(D_ALIGNLAB["alignlab_side__006"].name, D_ALIGNLAB["alignlab_side__006"].tag, D_ALIGNLAB["alignlab_side__006"].body, D_ALIGNLAB["alignlab_side__006"].desc, "alignlab_side__006", "alignlab")}
  ${subcard(D_ALIGNLAB["alignlab_side__007"].name, D_ALIGNLAB["alignlab_side__007"].tag, D_ALIGNLAB["alignlab_side__007"].body, D_ALIGNLAB["alignlab_side__007"].desc, "alignlab_side__007", "alignlab")}
  ${secTitle("4","결제수단별 환불 안내",null,"sec_refund")}
  <div class="grid2">
${col("blue","환불 안내 (카드·삼성페이·네이버페이)",
subcard(D_ALIGNLAB["alignlab_side__008"].name, D_ALIGNLAB["alignlab_side__008"].tag, D_ALIGNLAB["alignlab_side__008"].body, D_ALIGNLAB["alignlab_side__008"].desc, "alignlab_side__008", "alignlab")
)}
${col("blue","환불 안내 (계좌·무통장/가상계좌)",
subcard(D_ALIGNLAB["alignlab_side__009"].name, D_ALIGNLAB["alignlab_side__009"].tag, D_ALIGNLAB["alignlab_side__009"].body, D_ALIGNLAB["alignlab_side__009"].desc, "alignlab_side__009", "alignlab") + subcard(D_ALIGNLAB["alignlab_side__010"].name, D_ALIGNLAB["alignlab_side__010"].tag, D_ALIGNLAB["alignlab_side__010"].body, D_ALIGNLAB["alignlab_side__010"].desc, "alignlab_side__010", "alignlab")
)}
</div>
  ${secTitle("🔺","[예외케이스] 클레임/민원/보상 요청",null,"sec_exception")}
  ${caution(`예) 부작용으로 인한 병원 진료, 진료비 보상 요청 or 부작용 정도가 심하여 진료비 보상 요청`)}
  ${macro(D_ALIGNLAB["alignlab_side__011"].name, D_ALIGNLAB["alignlab_side__011"].tag, D_ALIGNLAB["alignlab_side__011"].body, D_ALIGNLAB["alignlab_side__011"].desc, "alignlab_side__011", "alignlab")}
  ${macro(D_ALIGNLAB["alignlab_side__012"].name, D_ALIGNLAB["alignlab_side__012"].tag, D_ALIGNLAB["alignlab_side__012"].body, D_ALIGNLAB["alignlab_side__012"].desc, "alignlab_side__012", "alignlab")}
  ${macro(D_ALIGNLAB["alignlab_side__013"].name, D_ALIGNLAB["alignlab_side__013"].tag, D_ALIGNLAB["alignlab_side__013"].body, D_ALIGNLAB["alignlab_side__013"].desc, "alignlab_side__013", "alignlab")}
  ${caution(`⚠️ 고객 서류 미수긍/지속 치료비 보상 요구\n★ 증빙 서류 없이 치료비 보상은 불가`)}
  ${guide(`💡 병원 내원 및 치료 안내 진행 시 팀 리드 공유 필수`)}
  ${secTitle("💠","[공통] 서류 제출 후",null,"sec_submit")}
  ${macro(D_ALIGNLAB["alignlab_side__014"].name, D_ALIGNLAB["alignlab_side__014"].tag, D_ALIGNLAB["alignlab_side__014"].body, D_ALIGNLAB["alignlab_side__014"].desc, "alignlab_side__014", "alignlab")}
  ${macro(D_ALIGNLAB["alignlab_side__015"].name, D_ALIGNLAB["alignlab_side__015"].tag, D_ALIGNLAB["alignlab_side__015"].body, D_ALIGNLAB["alignlab_side__015"].desc, "alignlab_side__015", "alignlab")}
...
현재는 신청 가능 기간이 경과되어 도움드리기 어려운 점 양해 부탁드립니다.`)}
  ...
  <div class="grid2">
    ${col("blue","🔹 전체 반품",
      subcard(D_ALIGNLAB["alignlab_refund__001"].name, D_ALIGNLAB["alignlab_refund__001"].tag, D_ALIGNLAB["alignlab_refund__001"].body, D_ALIGNLAB["alignlab_refund__001"].desc, "alignlab_refund__001", "alignlab")
      + subcard(D_ALIGNLAB["alignlab_refund__002"].name, D_ALIGNLAB["alignlab_refund__002"].tag, D_ALIGNLAB["alignlab_refund__002"].body, D_ALIGNLAB["alignlab_refund__002"].desc, "alignlab_refund__002", "alignlab")
      + subcard(D_ALIGNLAB["alignlab_refund__003"].name, D_ALIGNLAB["alignlab_refund__003"].tag, D_ALIGNLAB["alignlab_refund__003"].body, D_ALIGNLAB["alignlab_refund__003"].desc, "alignlab_refund__003", "alignlab")
    )}
    ${col("pink","🔹 부분 반품",
      subcard(D_ALIGNLAB["alignlab_refund__004"].name, D_ALIGNLAB["alignlab_refund__004"].tag, D_ALIGNLAB["alignlab_refund__004"].body, D_ALIGNLAB["alignlab_refund__004"].desc, "alignlab_refund__004", "alignlab")
      + subcard(D_ALIGNLAB["alignlab_refund__005"].name, D_ALIGNLAB["alignlab_refund__005"].tag, D_ALIGNLAB["alignlab_refund__005"].body, D_ALIGNLAB["alignlab_refund__005"].desc, "alignlab_refund__005", "alignlab")
      + subcard(D_ALIGNLAB["alignlab_refund__006"].name, D_ALIGNLAB["alignlab_refund__006"].tag, D_ALIGNLAB["alignlab_refund__006"].body, D_ALIGNLAB["alignlab_refund__006"].desc, "alignlab_refund__006", "alignlab")
...
반품 전 꼭 확인 부탁드립니다.`)
  ...
  <div class="grid2">
    ${col("blue","🔹 전체 반품",
      subcard(D_ALIGNLAB["alignlab_refund__007"].name, D_ALIGNLAB["alignlab_refund__007"].tag, D_ALIGNLAB["alignlab_refund__007"].body, D_ALIGNLAB["alignlab_refund__007"].desc, "alignlab_refund__007", "alignlab")
      + caution(`🎁 증정품 회수 O`)
    )}
    ${col("pink","🔹 부분 반품",
      subcard(D_ALIGNLAB["alignlab_refund__008"].name, D_ALIGNLAB["alignlab_refund__008"].tag, D_ALIGNLAB["alignlab_refund__008"].body, D_ALIGNLAB["alignlab_refund__008"].desc, "alignlab_refund__008", "alignlab")
      + caution(`🎁 증정품 회수 X`)
    )}
  </div>
  <div class="stack">
    ${col("gray","💡 복합 유형 (예: 불량 반품 + 단순변심 반품)",
      subcard(D_ALIGNLAB["alignlab_refund__009"].name, D_ALIGNLAB["alignlab_refund__009"].tag, D_ALIGNLAB["alignlab_refund__009"].body, D_ALIGNLAB["alignlab_refund__009"].desc, "alignlab_refund__009", "alignlab")
    )}
  </div>
  <div class="grid2">
    ${subcard(D_ALIGNLAB["alignlab_refund__011"].name, D_ALIGNLAB["alignlab_refund__011"].tag, D_ALIGNLAB["alignlab_refund__011"].body, D_ALIGNLAB["alignlab_refund__011"].desc, "alignlab_refund__011", "alignlab")}
  </div>

  ${secTitle("4", "결제수단별 환불 안내","전체·부분 공통","sec4")}
  <div class="grid2">
    ${col("blue","🔹 카드결제",
      subcard(D_ALIGNLAB["alignlab_refund__012"].name, D_ALIGNLAB["alignlab_refund__012"].tag, D_ALIGNLAB["alignlab_refund__012"].body, D_ALIGNLAB["alignlab_refund__012"].desc, "alignlab_refund__012", "alignlab")
    )}
    ${col("blue","🔹 계좌 환불",
      subcard(D_ALIGNLAB["alignlab_refund__013"].name, D_ALIGNLAB["alignlab_refund__013"].tag, D_ALIGNLAB["alignlab_refund__013"].body, D_ALIGNLAB["alignlab_refund__013"].desc, "alignlab_refund__013", "alignlab")
      + subcard(D_ALIGNLAB["alignlab_refund__014"].name, D_ALIGNLAB["alignlab_refund__014"].tag, D_ALIGNLAB["alignlab_refund__014"].body, D_ALIGNLAB["alignlab_refund__014"].desc, "alignlab_refund__014", "alignlab")
    )}
  </div>
`;
...
const ALIGNLAB_EXCHANGE = `
  ...
  <div class="grid2">
${col("blue","🔹 전체 교환",
subcard(D_ALIGNLAB["alignlab_exchange__001"].name, D_ALIGNLAB["alignlab_exchange__001"].tag, D_ALIGNLAB["alignlab_exchange__001"].body, D_ALIGNLAB["alignlab_exchange__001"].desc, "alignlab_exchange__001", "alignlab")
)}
${col("pink","🔹 부분 교환",
subcard(D_ALIGNLAB["alignlab_exchange__002"].name, D_ALIGNLAB["alignlab_exchange__002"].tag, D_ALIGNLAB["alignlab_exchange__002"].body, D_ALIGNLAB["alignlab_exchange__002"].desc, "alignlab_exchange__002", "alignlab")
)}
</div>
...
▶ 교환 희망 시 → 2부터 진행`)}
  ...
  <div class="grid2">
${col("blue","🔹 전체 교환",
subcard(D_ALIGNLAB["alignlab_exchange__003"].name, D_ALIGNLAB["alignlab_exchange__003"].tag, D_ALIGNLAB["alignlab_exchange__003"].body, D_ALIGNLAB["alignlab_exchange__003"].desc, "alignlab_exchange__003", "alignlab")
)}
${col("pink","🔹 부분 교환",
subcard(D_ALIGNLAB["alignlab_exchange__004"].name, D_ALIGNLAB["alignlab_exchange__004"].tag, D_ALIGNLAB["alignlab_exchange__004"].body, D_ALIGNLAB["alignlab_exchange__004"].desc, "alignlab_exchange__004", "alignlab") + subcard(D_ALIGNLAB["alignlab_exchange__005"].name, D_ALIGNLAB["alignlab_exchange__005"].tag, D_ALIGNLAB["alignlab_exchange__005"].body, D_ALIGNLAB["alignlab_exchange__005"].desc, "alignlab_exchange__005", "alignlab")
)}
</div>
...
🔗 IBK기업은행 : https://www.ibk.co.kr/`)}
  ...
  <div class="grid2">
${col("blue","🔹 전체 교환",
subcard(D_ALIGNLAB["alignlab_exchange__006"].name, D_ALIGNLAB["alignlab_exchange__006"].tag, D_ALIGNLAB["alignlab_exchange__006"].body, D_ALIGNLAB["alignlab_exchange__006"].desc, "alignlab_exchange__006", "alignlab") + caution(`🎁 증정품 회수 O`)
)}
${col("pink","🔹 부분 교환",
subcard(D_ALIGNLAB["alignlab_exchange__007"].name, D_ALIGNLAB["alignlab_exchange__007"].tag, D_ALIGNLAB["alignlab_exchange__007"].body, D_ALIGNLAB["alignlab_exchange__007"].desc, "alignlab_exchange__007", "alignlab") + caution(`🎁 증정품 회수 X`)
)}
</div>
  <div class="warn-note">⚠️ 고객 동의 / 교환 배송비 입금 완료 후 진행</div>
  ${secTitle("4", "검수 및 재출고 안내","전체·부분 공통","sec4")}
  ${macro(D_ALIGNLAB["alignlab_exchange__009"].name, D_ALIGNLAB["alignlab_exchange__009"].tag, D_ALIGNLAB["alignlab_exchange__009"].body, D_ALIGNLAB["alignlab_exchange__009"].desc, "alignlab_exchange__009", "alignlab")}
...
반품 전 꼭 확인 부탁드립니다.`)
  ...
  <div class="grid2">
    ...
    ${col("pink","🔹 부분 교환",
      subcard(D_ALIGNLAB["alignlab_exchange__004"].name, D_ALIGNLAB["alignlab_exchange__004"].tag, D_ALIGNLAB["alignlab_exchange__004"].body, D_ALIGNLAB["alignlab_exchange__004"].desc, "alignlab_exchange__004", "alignlab")
      + subcard(D_ALIGNLAB["alignlab_exchange__005"].name, D_ALIGNLAB["alignlab_exchange__005"].tag, D_ALIGNLAB["alignlab_exchange__005"].body, D_ALIGNLAB["alignlab_exchange__005"].desc, "alignlab_exchange__005", "alignlab")
    )}
  </div>
  ${guide(`→ 입금자명·입금금액 확인 후 IBK 기업은행 계좌 조회
🔗 IBK기업은행 : https://www.ibk.co.kr/`)}
