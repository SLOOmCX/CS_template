...
/* === 단순변심 교환/반품 통합판 (2026-08-26) — 슬룸 SLM_MERGE_TEMPLATE 구조(5단계+상담플로우)만 참고, 콘텐츠는 심플리케어 기존 SIMPLICARE_REFUND, SIMPLICARE_EXCHANGE 내용을 그대로 재배치. 새 데이터 항목 없이 위 D_SIMPLICARE 기존 키(simplicare_refund__NNN, simplicare_exchange__NNN)를 그대로 재사용함 === */
const SIMPLICARE_MERGE_TEMPLATE = `
  <h1>🔄 단순변심 교환/반품</h1>
