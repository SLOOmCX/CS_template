...
👉🏻 100% 환불 이벤트 상세 조건 : https://dramang.com/article/notice/1/4/`)}
...
👉🏻 상세 조건 : https://dramang.com/article/notice/1/4/
👉🏻 닥터아망 채팅 상담 바로가기 : http://dramang.channel.io/
※ 상담 가능 시간 : 월–금 09:30-17:00 (점심시간 12:30-13:30 / 주말·공휴일 휴무)`)}
...
저희 닥터아망을 믿고 조금만 더 사용해 보신 뒤 기간 내 채팅 상담으로 접수 부탁드립니다 :)
...
또한 닥터아망에서 운영 중인 <100% 환불 이벤트>는 제품 수령 후 40일 이내 신청 가능하며, 30일간 꾸준히 섭취하신 경우에만 환불이 가능합니다.
...
현재 닥터아망에서는 첫 구매 고객님을 위한 <100% 환불 이벤트>를 운영 중입니다 :)
...
👉🏻 상세 조건 확인하기 : https://dramang.com/article/notice/1/4/`)}
...
반품 배송비 : 6,000원
🏦 기업은행 078-221425-01-051 (예금주: 주식회사 올릿)
...
`고객님의 경우, 닥터아망에서 제공하는 세트 구성 상품이 아닌 원하시는 제품을 개별로 선택해 구매하신 주문건으로 확인됩니다.
...
`다만, 닥터아망 제품 사용 시 피부 타입에 따라 일시적인 반응이나 트러블은 발생할 수 있어요.
...
닥터아망는 공정거래위원회 고시 소비자 분쟁 해결 기준에 따라 트러블 관련 환불 제도를 운영하고 있어 필요한 서류 접수 후 전액 환불을 도와드리고 있습니다.`,
...
✍🏽 택배 박스 윗면에 <b>[ 불량 / CJ대한통운 / 닥터아망 ]</b> 표기 부탁드립니다.
...
`저희 닥터아망의 제품 이용 후 불편을 드려 대단히 죄송합니다.
닥터아망는 공정거래위원회 고시 소비자 분쟁 해결 기준에 따라 트러블 관련 환불 제도를 운영하고 있어 필요한 서류 접수 후 전액 환불을 도와 드리겠습니다.`)}
...
📑 Slack 문의 양식 : <a href="https://app.notion.com/p/CX-295d64378d488024820af68dc6ea62c2?source=copy_link#2e3d64378d4880a8b3cbf3f27e1a0eba" target="_blank">SOP 상품전략팀·상품팀↔CX팀 협업 프로세스(CX팀 → 상품전략팀·상품팀)</a> 참고</div>
  ...
  ${macro("사진·영상 증빙 요청","dramang_봉제불량_증빙",
`말씀해 주신 봉제선·자수 패치가 풀리거나 터진 부위 확인을 위해, 제품 전체 사진(또는 영상)과 문제 부위를 확대한 사진을 함께 보내주실 수 있을까요?`)}
  <div class="grid2">
${col("blue","🔹 불량 인정 시",
subcard("교환/반품 안내","dramang_봉제불량_인정",
`보내주신 사진 확인 결과 제품 불량으로 확인되어, 교환 또는 반품(전액 환불) 도와드리겠습니다.
어떤 방식으로 도와드리면 좋을지 말씀해 주시면, 이어서 포장·회수 안내 도와드리겠습니다.`)
)}
${col("pink","🔹 불량 미인정(정상 판정) 시",
subcard("정상 판정 안내","dramang_봉제불량_미인정",
...
불편을 드려 죄송하며, 추가로 궁금하신 점 있으시면 다시 말씀해 주세요.`)
  ...
  ${macro("사진·영상 증빙 요청","dramang_벨크로불량_증빙",
`말씀해 주신 벨크로가 붙지 않거나 밴드가 늘어난 부위 확인을 위해, 제품 전체 사진(또는 영상)과 문제 부위를 확대한 사진을 함께 보내주실 수 있을까요?`)}
  <div class="grid2">
${col("blue","🔹 불량 인정 시",
subcard("교환/반품 안내","dramang_벨크로불량_인정",
`보내주신 사진 확인 결과 제품 불량으로 확인되어, 교환 또는 반품(전액 환불) 도와드리겠습니다.
어떤 방식으로 도와드리면 좋을지 말씀해 주시면, 이어서 포장·회수 안내 도와드리겠습니다.`)
)}
${col("pink","🔹 불량 미인정(정상 판정) 시",
subcard("정상 판정 안내","dramang_벨크로불량_미인정",
`다만 확인 결과 제품 자체의 불량이라기보다(보관·사용 환경 등에 따른) 정상 범위로 확인되어, 불량 처리는 어려운 점 양해 부탁드립니다. 🙏🏻
불편을 드려 죄송하며, 추가로 궁금하신 점 있으시면 다시 말씀해 주세요.
(예: 장기 사용에 따른 자연 마모로 판단되는 경우)`)
)}
</div>
  ${caution(`📝 근거/비고: 벨크로 체결형 구조 반영.`)}

  <div class="grp-h">3. 아쿠아가드 이어쉴드 — 접착 불량(안 붙음·쉽게 떨어짐)</div>
  ${macro("사진·영상 증빙 요청","dramang_접착불량_증빙",
`말씀해 주신 패치가 붙지 않거나 떨어지는 상태 확인을 위해, 제품 전체 사진(또는 영상)과 문제 부위를 확대한 사진을 함께 보내주실 수 있을까요?`)}
  <div class="grid2">
${col("blue","🔹 불량 인정 시",
subcard("교환/반품 안내","dramang_접착불량_인정",
`보내주신 사진 확인 결과 패치 불량으로 확인되어, 교환 또는 반품(전액 환불) 도와드리겠습니다.
어떤 방식으로 도와드리면 좋을지 말씀해 주시면, 이어서 포장·회수 안내 도와드리겠습니다.`)
)}
${col("pink","🔹 불량 미인정(정상 판정) 시",
subcard("정상 판정 안내","dramang_접착불량_미인정",
`피부 유분·물기가 있는 상태에서 부착 시 접착력이 약해질 수 있어요. 마른 피부에 부착하는 방법을 다시 안내드려도 될까요?`)
)}
</div>
  ${caution(`📝 근거/비고: 실리콘겔 접착 패치 특성 반영, 사용법 오인과 실제 불량 구분 필요.`)}

  <div class="grp-h">4. 아쿠아가드 이어쉴드 — 방수 불량(사용 중 물 스며듦) / 낱장 파손</div>
  ${macro("사진·영상 증빙 요청","dramang_방수불량_증빙",
`말씀해 주신 물이 스며든 상황 또는 패치 찢어짐 부위 확인을 위해, 제품 전체 사진(또는 영상)과 문제 부위를 확대한 사진을 함께 보내주실 수 있을까요?`)}
  <div class="grid2">
${col("blue","🔹 불량 인정 시",
subcard("교환/반품 안내","dramang_방수불량_인정",
`보내주신 사진 확인 결과 패치 불량으로 확인되어, 교환 또는 반품(전액 환불) 도와드리겠습니다.
어떤 방식으로 도와드리면 좋을지 말씀해 주시면, 이어서 포장·회수 안내 도와드리겠습니다.`)
)}
${col("pink","🔹 불량 미인정(정상 판정) 시",
subcard("정상 판정 안내","dramang_방수불량_미인정",
`다만 확인 결과 제품 자체의 불량이라기보다(보관·사용 환경 등에 따른) 정상 범위로 확인되어, 불량 처리는 어려운 점 양해 부탁드립니다. 🙏🏻
불편을 드려 죄송하며, 추가로 궁금하신 점 있으시면 다시 말씀해 주세요.`)
)}
</div>
...
subcard("i. 월-금 오후 2시 이전 상담","dramang_교환_재출고A",
`<b>🚚 교환 제품 재출고 일정 안내드리겠습니다.</b>

· 출고 : 오늘 출고 예정
· 배송 : 출고일로부터 영업일 기준 2~3일 소요
· 택배사 : CJ대한통운`) +
subcard("ii. 월-목 오후 2시 이후 상담","dramang_교환_재출고B",
`<b>🚚 교환 제품 재출고 일정 안내드리겠습니다.</b>

· 출고 : 오늘 출고 마감으로 내일 출고 예정
· 배송 : 출고일로부터 영업일 기준 2~3일 소요
· 택배사 : CJ대한통운`) +
subcard("iii. 금요일 오후 2시 이후 상담","dramang_교환_재출고C",
`<b>🚚 교환 제품 재출고 일정 안내드리겠습니다.</b>
...
subcard("환불 절차 안내(카드·삼성페이·네이버페이)","dramang_환불_카드",
`환불은 아래 절차를 거쳐 진행되며, 영업일 기준 약 6~8일 정도 소요됩니다.
...
이용에 불편을 드려 다시 한 번 죄송합니다.`) + subcard("환불 절차 안내(계좌·무통장/가상계좌)","dramang_환불_계좌",
`환불은 아래 절차를 거쳐 진행되며, 영업일 기준 약 6~8일 정도 소요됩니다.
...
이용에 불편을 드려 다시 한 번 죄송합니다.`) + subcard("▶ 계좌 정보 확인","dramang_환불_계좌확인",
`소중한 정보 확인 감사합니다.
해당 계좌로 환불 계좌 등록이 완료되었습니다.
